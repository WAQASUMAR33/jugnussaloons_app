...
<body class="h-full flex items-center justify-center p-4 bg-gradient-to-br from-slate-100 via-indigo-50/50 to-slate-100 text-slate-800 antialiased min-h-screen">
    ...
    <div x-data="{ 
        ...
        <!-- Light Branding Header -->
        <div class="text-center mb-6">
            <div class="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-indigo-600 text-white shadow-lg shadow-indigo-600/30 mb-3 transform hover:scale-105 transition-transform">
                <!-- Scissors SVG -->
                <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.121 14.121L19 19m-7-7l7-7m-7 7l-2.879 2.879M12 12L9.121 9.121m0 0A3 3 0 104.5 4.5a3 3 0 004.621 4.621zm0 0L12 12m-2.879 2.879a3 3 0 10-4.243 4.243 3 3 0 004.243-4.243z"></path>
                </svg>
            </div>
            <h1 class="text-2xl font-extrabold tracking-tight text-slate-900">Jugnu Saloon</h1>
            <p class="text-xs font-semibold text-indigo-600 uppercase tracking-widest mt-0.5">Material Suite &bull; Light Theme</p>
        </div>
