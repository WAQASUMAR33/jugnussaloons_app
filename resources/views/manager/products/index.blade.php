...
<div x-data="{ 
    ...
    editModalOpen: false,
    editProduct: { id: null, title: '', price: 0, discount: 0, discounted_price: 0, stock: 0, image: null },
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-100 text-sm">
                    ...
                    <tr class="hover:bg-slate-50/60 transition-colors">
                        ...
                        <td class="py-4 px-6">
                            @if($product->stock > 10)
                                <span class="px-2.5 py-1 bg-emerald-100 text-emerald-800 text-xs font-bold">
                            ...
                            @else
                                <span class="px-2.5 py-1 bg-rose-100 text-rose-800 text-xs font-bold">
                                    Out of Stock (0)
                                </span>
                            @endif
                        </td>
