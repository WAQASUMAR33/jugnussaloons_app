...
<div x-data="{ 
    ...
    editAccount: { id: null, account_category_id: '', name: '', father_name: '', address: '', date_of_birth: '', date_of_anniversary: '', phone_no1: '', phone_no2: '', card_no: '', balance: 0 }
}" class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-6 border border-slate-200 shadow-sm">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xs font-semibold text-slate-500 mt-0.5">Register customer profiles, track opening balances, anniversaries, and contact numbers.</p>
            </div>
        </div>
                ...
                <tbody class="divide-y divide-slate-100 text-sm">
                    ...
                    <tr>
                        <td colspan="8" class="py-12 text-center text-slate-400">
                            <p class="text-sm font-semibold">No customer accounts registered yet.</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
            ...
            <form method="POST" action="{{ route('manager.accounts.store') }}" class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="account_category_id" required class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 text-sm font-medium focus:ring-2 focus:ring-indigo-600">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label class="block text-xs font-bold text-slate-700 uppercase mb-1">Date of Birth (Optional)</label>
                        <input type="date" name="date_of_birth" 
                               class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 text-sm font-medium focus:ring-2 focus:ring-indigo-600">
                    </div>

                    <div>
                        <label class="block text-xs font-bold text-slate-700 uppercase mb-1">Anniversary (Optional)</label>
